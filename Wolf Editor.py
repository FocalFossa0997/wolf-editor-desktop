...
if os.path.exists("../WolfEditorDocuments"):
    pass
else:
    os.mkdir("../WolfEditorDocuments")
...
while True:    
    ...
    if event == 'About': # of user clicks about:
        alayout = [  [sg.Image("WolfEditor.gif")],
    ...
    if event == 'Load Using Selector':
        files = [f for f in listdir('../WolfEditorDocuments') if isfile(join('../WolfEditorDocuments', f))]
        lfusLayout = [
        ...
        while True:
            ...
            if lfusEvent == 'Load': # if user closes window or clicks dismiss in the about windows
                ...
                if len(filePathToLoad) == 0:
                    ...
                    filePathToLoad = "../WolfEditorDocuments/" + filePathToLoad
